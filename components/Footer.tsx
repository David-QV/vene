...
const services = [
  ...
  { label: 'Commercial Remodeling',   href: '/services#remodeling' },
  { label: 'Tenant Improvements',     href: '/services#tenant-improvements' },
  { label: 'Drywall & Interior',      href: '/services#drywall' },
    ...
    <footer className="bg-navy-950 text-white">
      ...
      <div className="bg-navy-900 border-t border-navy-700">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="section-label mb-1">Start Today</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="font-serif text-xl font-bold text-white">VENE</p>
          ...
          {/* Services */}
          <div>
            <h3 className="font-serif font-bold text-white mb-5 text-sm uppercase tracking-widest">
              Services
            </h3>
